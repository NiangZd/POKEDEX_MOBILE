import 'package:app_prova/db/database_helper.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:flutter/material.dart';
import '../../class/Pokemon.dart';
import '../../class/cores.dart';

class TelaDetalheMeusPok extends StatelessWidget {
  const TelaDetalheMeusPok({super.key});
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        onPressed: () {
                          _showConfirmationDialog(context, pokemon.id);
                        },
                        child: const Text(
                          'LIBERAR',
                          style: TextStyle(
  ...
  // FUNÇÃO PRA MOSTRAR UMA CAIXA DE DIÁLOGO PRA CONFIRMAÇÃO DA LIBERAÇÃO
  void _showConfirmationDialog(BuildContext context, int pokemonId) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text("Confirmar Liberação"),
          content: const Text("Tem certeza que deseja liberar este Pokémon?"),
          actions: <Widget>[
            TextButton(
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                await databaseHelper.liberarPokemon(pokemonId);
                Navigator.of(context).pop();
                Navigator.pushNamed(context, "/");
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text("Pokémon liberado com sucesso!")),
                );
              },
            ),
          ],
